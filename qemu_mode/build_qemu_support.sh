...
patch -p1 <../patches/cgc.diff || exit 1
...
CFLAGS="-O3 -ggdb" ./configure --disable-system --disable-docs \
  --enable-linux-user --disable-gtk --disable-sdl --disable-vnc \
  --target-list="${CPU_TARGET}-linux-user" --python=python2 --enable-pie --enable-kvm || exit 1
